...
SECRET_KEY = 'django-insecure-uz1p-rljzx992smwsqsv_jjk@xd_oq^r^+wg_@)-4^!uu5c2av'
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            os.path.join(PROJECT_DIR, 'finsmart/templates'),
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
LOGIN_URL = '/login/'
LOGIN_REDIRECT_URL = '/'
ACCOUNT_SIGNUP_REDIRECT_URL = 'account:profile_update'
